 ...
 */
export declare function isHttpInterceptorRouteConfig(
...
export declare class AuthClientConfig {
   ...
   */
  get(): AuthConfig;
  static ɵfac: i0.ɵɵFactoryDef<AuthClientConfig, [{ optional: true }]>;
  static ɵprov: i0.ɵɵInjectableDef<AuthClientConfig>;
}
/**
