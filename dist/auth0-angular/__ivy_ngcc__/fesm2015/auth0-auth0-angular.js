...
/*@__PURE__*/ (function () {
  ɵngcc0.ɵsetClassMetadata(
    ...
    function () {
      return [{ type: ɵngcc1.Location }, { type: ɵngcc0.Injector }];
    },
    null
  );
})();
...
AuthClientConfig.ɵprov = ɵɵdefineInjectable({
  factory: function AuthClientConfig_Factory() {
    return new AuthClientConfig(ɵɵinject(AuthConfigService, 8));
  },
...
AuthService.ɵfac = function AuthService_Factory(t) {
  return new (t || AuthService)(
    ɵngcc0.ɵɵinject(Auth0ClientService),
    ɵngcc0.ɵɵinject(AuthClientConfig),
    ɵngcc0.ɵɵinject(ɵngcc1.Location),
    ɵngcc0.ɵɵinject(AbstractNavigator)
  );
};
...
AuthGuard.ɵprov = ɵɵdefineInjectable({
  factory: function AuthGuard_Factory() {
    return new AuthGuard(ɵɵinject(AuthService));
  },
  token: AuthGuard,
  providedIn: 'root',
});
...
export {
  ...
  Auth0ClientFactory as ɵa,
  Auth0ClientService as ɵb,
  AbstractNavigator as ɵc,
};
